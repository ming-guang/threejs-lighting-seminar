...
<template>
    ...
    <div class="mt-2">
        ...
        <input id="intensity" v-model="intensity" type="range" min="0" max="1" step="0.01"
    ...
    <div class="grid grid-cols-3 grid-gap-4">
        <div class="mt-2">
            <label for="x" class="block mb-2 text-sm font-medium text-gray-900">x</label>
            <input type="number" id="x"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                v-model="x" @change="onChange()">
        </div>
        <div class="mt-2">
            <label for="y" class="block mb-2 text-sm font-medium text-gray-900">y</label>
            <input type="number" id="y"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                v-model="y" @change="onChange()">
        </div>
        <div class="mt-2">
            <label for="z" class="block mb-2 text-sm font-medium text-gray-900">z</label>
            <input type="number" id="z"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                v-model="z" @change="onChange()">
        </div>
    </div>
</template>
